...
<div class="p-4">
	<fieldset class="fieldset mt-3">
		<legend class="fieldset-legend">Add The signal</legend>
		<textarea
			name="text"
			...
			placeholder="print"
		></textarea>
		<p class="label">Add The Signal That Need To Send To Active Window</p>
	</fieldset>
	...
	<button
		...
		onclick={() => {
			keybindState.holdKeybinds.args = `${signal} ,${window}`;
