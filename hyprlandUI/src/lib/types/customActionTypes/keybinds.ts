...
export interface ReceiveKeybindHelp {
    action: "KEYBIND_HELP" | "DISPATCHER_HELP" | "GET_DISPATCHERS" | "CREATE_NEW",
...
export interface ReceiveKeybindActionError {
    status: "SERIALIZABLE" | "INVALID_ACTION_TYPE" | "EMPTY_HELP_PAGE" | "EMPTY_PAYLOAD" | "EMPTY_DISPATCHERS" | "EMPTY_DISPATCHER_COMMAND" | "EMPTY_DATA" | "NEW_BIND_CREATING_FAILED",
    message: string
}