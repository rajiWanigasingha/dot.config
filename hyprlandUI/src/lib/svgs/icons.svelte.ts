export default function getIcon(name: "search" | "add" | "edit" | "delete" | "arrow_right" | "minus" | "close" | "error" | "bind" | "arrow_left" | "curve", size: number = 24) {
    switch (name) {
        ...
        case "curve" : {
            return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24"><path fill="currentColor" d="M18 20q0-2.9-1.1-5.45t-3-4.45t-4.45-3T4 6V4q3.3 0 6.213 1.263T15.3 8.7t3.438 5.088T20 20z"/></svg>`
        }
    }
}